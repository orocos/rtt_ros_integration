...
macro( catkin_orocos_devel_output LIB_TARGET_NAME TYPE_SUFFIX)
  set_target_properties(${LIB_TARGET_NAME}
    PROPERTIES LIBRARY_OUTPUT_DIRECTORY ${CATKIN_DEVEL_PREFIX}/lib${OROCOS_SUFFIX}/${PROJECT_NAME}${TYPE_SUFFIX})
...
macro( catkin_orocos_component LIB_TARGET_NAME)
  orocos_component(${LIB_TARGET_NAME} ${ARGN})
  catkin_orocos_devel_output(${LIB_TARGET_NAME} "")
endmacro( catkin_orocos_component )
